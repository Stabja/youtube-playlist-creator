    ...
    <div className="kt-header__topbar">
      ...
      >
        ...
        <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-lg">
          <div
            className="kt-quick-search kt-quick-search--dropdown kt-quick-search--result-compact"
      ...
      <div className="kt-header__topbar-item dropdown">
        ...
        <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
          <form>
            {/* <!--begin: Head --> */}
            <div
              className="kt-head kt-head--skin-dark"
              style={{ "backgroundImage": "url(assets/media/misc/bg-1.jpg)" }}
            >
              <h3 className="kt-head__title">
                User Quick Actions
        ...
        <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
          <form>
            ...
            <div className="kt-mycart">
              ...
              >
                <div className="kt-mycart__info">
                  <span className="kt-mycart__icon">
                    <i className="flaticon2-shopping-cart-1 kt-font-success"></i>
                  </span>
              ...
              <div
                className="kt-mycart__body kt-scroll"
                data-scroll="true"
                data-height="245"
                data-mobile-height="200"
              >
