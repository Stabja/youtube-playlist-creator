              ...
              <ul className="kt-menu__subnav">
                <li className="kt-menu__item " aria-haspopup="true">
                  <a href="/index.html" className="kt-menu__link ">
                    ...
                    <span className="kt-menu__link-text">My Account</span>
                  </a>
                </li>
                <li className="kt-menu__item " aria-haspopup="true">
                  <a href="/#" className="kt-menu__link ">
                    ...
                    <span className="kt-menu__link-text">Task Manager</span>
                ...
                >
                  ...
                  >
                    ...
                    <span className="kt-menu__link-text">Team Manager</span>
                ...
                >
                  ...
                  >
                    ...
                    <span className="kt-menu__link-text">Projects Manager</span>
                    <i className="kt-menu__hor-arrow la la-angle-right"></i>
                    <i className="kt-menu__ver-arrow la la-angle-right"></i>
                  </a>
                  <div className="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                ...
                <ul className="kt-menu__content">
                  <li className="kt-menu__item ">
                    <h3 className="kt-menu__heading kt-menu__toggle">
                      ...
                      <span className="kt-menu__link-text">Task Reports</span>
                      <i className="kt-menu__ver-arrow la la-angle-right"></i>
                    </h3>
                  ...
                  <li className="kt-menu__item ">
                    <h3 className="kt-menu__heading kt-menu__toggle">
                      ...
                      <span className="kt-menu__link-text">Profit Margins</span>
                      <i className="kt-menu__ver-arrow la la-angle-right"></i>
                    </h3>
                    <ul className="kt-menu__inner">
                      <li className="kt-menu__item " aria-haspopup="true">
                    ...
                    <ul className="kt-menu__inner">
                      ...
                      <li className="kt-menu__item " aria-haspopup="true">
                        <a href="/#" className="kt-menu__link ">
                          ...
                          <span className="kt-menu__link-text">Executives</span>
                        </a>
                      </li>
                    </ul>
                  </li>
              ...
              <ul className="kt-menu__subnav">
                ...
                >
                  ...
                  >
                    ...
                    <span className="kt-menu__link-text">Social Presence</span>
                    <i className="kt-menu__hor-arrow la la-angle-right"></i>
                    <i className="kt-menu__ver-arrow la la-angle-right"></i>
                  </a>
                  <div className="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                ...
                <li className="kt-menu__item " aria-haspopup="true">
                  <a href="/#" className="kt-menu__link ">
                    ...
                    <span className="kt-menu__link-text">Campaigns</span>
                    <span className="kt-menu__link-badge">
                      <span className="kt-badge kt-badge--success kt-badge--rounded">
                        3
                      </span>
                    ...
                    <ul className="kt-menu__subnav">
                      <li className="kt-menu__item " aria-haspopup="true">
                        <a href="/#" className="kt-menu__link ">
                          ...
                          <span className="kt-menu__link-badge">
                            <span className="kt-badge kt-badge--danger kt-badge--rounded">
                              3
                            </span>
                          </span>
                        </a>
