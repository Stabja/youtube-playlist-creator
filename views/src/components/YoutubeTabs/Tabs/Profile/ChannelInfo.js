            ...
            <div className="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md">
              ...
              <ul className="kt-nav">
                ...
                <li className="kt-nav__foot">
                  <a className="btn btn-label-danger btn-bold btn-sm" href="#">
                    Upgrade plan
                  </a>
                  <a
          ...
          <div className="kt-widget kt-widget--user-profile-1">
            ...
            <div className="kt-widget__body">
              ...
              <div className="kt-widget__items">
                <a href="overview.html" className="kt-widget__item ">
                ...
                <a href="account-information.html" className="kt-widget__item ">
                  <span className="kt-widget__section">
                    <span className="kt-widget__icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="change-password.html" className="kt-widget__item ">
                  <span className="kt-widget__section">
                    <span className="kt-widget__icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="kt-widget__desc">Change Passwort</span>
                  </span>
                  <span className="kt-badge kt-badge--unified-danger kt-badge--sm kt-badge--rounded kt-badge--bolder">
                    5
                  </span>
                </a>
                <a href="email-settings.html" className="kt-widget__item ">
                  <span className="kt-widget__section">
                    <span className="kt-widget__icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <span className="kt-widget__section">
                    ...
                    <span href="#" className="kt-widget__desc">
                      Tax information
                    </span>
                  </span>
                  <span className="kt-badge kt-badge--unified-brand kt-badge--inline kt-badge--bolder">
                    new
                  </span>
                </a>
                <a
