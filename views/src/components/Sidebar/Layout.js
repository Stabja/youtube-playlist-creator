    ...
    <div id="sidebar-layout-section">
      ...
      >
        <a href="javascript:;" className="kt-menu__link kt-menu__toggle">
          ...
          <span className="kt-menu__link-text">Skins</span>
          ...
          <ul className="kt-menu__subnav">
            ...
            <li className="kt-menu__item " aria-haspopup="true">
              ...
              >
                ...
                <span className="kt-menu__link-text">Light Aside</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">Dark Header</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      >
        <a href="javascript:;" className="kt-menu__link kt-menu__toggle">
          ...
          <span className="kt-menu__link-text">Subheaders</span>
          <i className="kt-menu__ver-arrow la la-angle-right"></i>
        </a>
        <div className="kt-menu__submenu ">
          <span className="kt-menu__arrow"></span>
          <ul className="kt-menu__subnav">
            ...
            <li className="kt-menu__item " aria-haspopup="true">
              ...
              >
                ...
                <span className="kt-menu__link-text">Toolbar Nav</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">Actions Buttons</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a href="layout/subheader/tabbed.html" className="kt-menu__link ">
                <i className="kt-menu__link-bullet kt-menu__link-bullet--dot">
                  <span></span>
                </i>
                <span className="kt-menu__link-text">Tabbed Nav</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">classNameic</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a href="layout/subheader/none.html" className="kt-menu__link ">
                <i className="kt-menu__link-bullet kt-menu__link-bullet--dot">
                  <span></span>
                </i>
                <span className="kt-menu__link-text">None</span>
              </a>
            </li>
          </ul>
        </div>
          ...
          <ul className="kt-menu__subnav">
            ...
            <li className="kt-menu__item " aria-haspopup="true">
              ...
              >
                ...
                <span className="kt-menu__link-text">Fixed Content</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">Minimized Aside</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a href="layout/general/no-aside.html" className="kt-menu__link ">
                <i className="kt-menu__link-bullet kt-menu__link-bullet--dot">
                  <span></span>
                </i>
                <span className="kt-menu__link-text">No Aside</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">Empty Page</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">Fixed Footer</span>
              </a>
            </li>
            <li className="kt-menu__item " aria-haspopup="true">
              <a
              ...
              >
                ...
                <span className="kt-menu__link-text">No Header Menu</span>
              </a>
            </li>
          </ul>
        </div>
