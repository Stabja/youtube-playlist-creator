...
exports.createPlaylist = (accessToken, apiKey, playlistTitle, playlistDescription) => {
...
exports.searchVideo = (accessToken, apiKey, query) => {
  let youtube = google.youtube('v3');
  return new Promise((resolve, reject) => {
    youtube.search.list({
      oauth_token: accessToken,
...
exports.insertPlaylistItem = (accessToken, apiKey, playlistID, videoID) => {
  let youtube = google.youtube('v3');
  return new Promise((resolve, reject) => {
    const payload = {
      snippet: {
...
exports.insertTracksAsync = async (playlistId) => {
...
exports.insertTracksAsyncNew = async (playlistId) => {
  const tracksList = require('./tracks.json');
  let videoIdsList = [];
